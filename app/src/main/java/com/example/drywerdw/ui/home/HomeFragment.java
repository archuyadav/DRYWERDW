package com.example.drywerdw.ui.home;
...
import com.example.drywerdw.LocationActivity;
...
public class HomeFragment extends Fragment implements PermissionsListener {
    private TextView pickDrop;
    private static final int REQUEST_CHECK_SETTINGS = 23;
    private MapView mapView;
    public static final String API_KEY = "pk.eyJ1Ijoic2h1YmhhbTIwMTIiLCJhIjoiY2s2OWp1cDd2MGZmczNscG1ianlsODQwNyJ9.MTaNXfRmr2vsq1SF_zGRaw";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pickDrop = v.findViewById(R.id.pickDrop);
        pickDrop.setOnClickListener(new View.OnClickListener() {
            @Override
